...
struct Java_FMID_Cache
{
    ...
    jfieldID
              PIP_Problem_Control_Parameter_Value_PIVOT_ROW_STRATEGY_MAX_COLUMN_ID;
 ...
 */
jobject
build_java_artificial_parameter_sequence(JNIEnv * env, const
                                         PIP_Tree_Node::
 ...
 */
jobject
build_java_grid_generator_system(JNIEnv * env, const
 ...
 */
jobject
build_java_linear_expression_coefficient(JNIEnv * env, const
                                         Coefficient & coeff);
