...
build_cxx_artificial_parameter (JNIEnv * env, jobject j_artificial_parameter)
{
    ...
    Linear_Expression le = build_cxx_linear_expression(env,
                                                       j_le);
...
build_cxx_variables_set (JNIEnv * env, jobject j_v_set)
{
    // Get the iterator.
    jobject j_iter
        = env->CallObjectMethod(j_v_set,
                                cached_FMIDs.Variables_Set_iterator_ID);
...
build_cxx_bounded_overflow (JNIEnv * env, jobject j_bounded_overflow)
{
    jint bounded_overflow
        = env->CallIntMethod(j_bounded_overflow,
                             cached_FMIDs.
...
{
    jint bounded_rep
        = env->CallIntMethod(j_bounded_rep,
                             cached_FMIDs.
...
{
    jint bounded_width
        = env->CallIntMethod(j_bounded_width,
                             cached_FMIDs.Bounded_Integer_Type_Width_ordinal_ID);
...
{
    jint opt_mode
        = env->CallIntMethod(j_opt_mode,
                             cached_FMIDs.Optimization_Mode_ordinal_ID);
...
jobject
build_java_control_parameter_name (JNIEnv * env, const
                                   MIP_Problem::Control_Parameter_Name & cp_name)
{
...
jobject
build_java_control_parameter_value (JNIEnv * env, const
                                    MIP_Problem::Control_Parameter_Value &
                                    cp_value)
{
...
jobject
build_java_pip_problem_control_parameter_name (JNIEnv * env, const
                                               PIP_Problem::
                                               Control_Parameter_Name & cp_name)
{
    jclass j_cp_name_class
        = env->FindClass(
              "parma_polyhedra_library/PIP_Problem_Control_Parameter_Name");
...
jobject
build_java_pip_problem_control_parameter_value (JNIEnv * env, const
                                                PIP_Problem::
...
build_cxx_generator (JNIEnv * env, jobject j_generator)
{
    ...
    switch (generator_type_ordinal)
    {
        ...
        case 2:
            {
                jobject j_div
                    = env->GetObjectField(j_generator,
                                          cached_FMIDs.Generator_div_ID);
...
{
    jobject j_le
        = env->GetObjectField(j_grid_generator,
                              cached_FMIDs.Grid_Generator_le_ID);
    jobject grid_generator_type
        = env->GetObjectField(j_grid_generator,
                              cached_FMIDs.Grid_Generator_gt_ID);
...
build_java_constraint (JNIEnv * env, const Constraint & c)
{
    ...
    jobject rhs
        = build_java_linear_expression_coefficient(env,
...
jobject
build_java_artificial_parameter (JNIEnv * env, const
