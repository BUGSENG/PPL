...
int
ppl_assign_Linear_Expression_from_Linear_Expression (ppl_Linear_Expression_t
                                                     dst,
                                                     ppl_const_Linear_Expression_t
                                                     src) try
{
...
int
ppl_add_Linear_Expression_to_Linear_Expression (ppl_Linear_Expression_t
                                                dst,
                                                ppl_const_Linear_Expression_t
                                                src) try
{
...
int
ppl_subtract_Linear_Expression_from_Linear_Expression (ppl_Linear_Expression_t
                                                       dst,
                                                       ppl_const_Linear_Expression_t
                                                       src) try
{
...
int
ppl_assign_Constraint_System_from_Constraint_System (ppl_Constraint_System_t
                                                     dst,
                                                     ppl_const_Constraint_System_t
                                                     src) try
{
...
int
ppl_Constraint_System_empty (ppl_const_Constraint_System_t cs) try
{
    const Constraint_System & ccs = *to_const(cs);
...
int
ppl_Constraint_System_has_strict_inequalities (ppl_const_Constraint_System_t
                                               cs) try
{
    const Constraint_System & ccs = *to_const(cs);
...
int
ppl_assign_Generator_System_from_Generator_System (ppl_Generator_System_t
                                                   dst,
...
int
ppl_Generator_System_empty (ppl_const_Generator_System_t gs) try
{
...
int
ppl_assign_Congruence_System_from_Congruence_System (ppl_Congruence_System_t
                                                     dst,
                                                     ppl_const_Congruence_System_t
                                                     src) try
{
...
int
ppl_Congruence_System_empty (ppl_const_Congruence_System_t cs) try
{
    const Congruence_System & ccs = *to_const(cs);
...
int
ppl_assign_Grid_Generator_from_Grid_Generator (ppl_Grid_Generator_t       dst,
...
int
ppl_Grid_Generator_System_empty (ppl_const_Grid_Generator_System_t gs) try
{
...
int
ppl_Grid_Generator_System_insert_Grid_Generator (ppl_Grid_Generator_System_t gs,
...
ppl_new_Grid_Generator_System_const_iterator_from_Grid_Generator_System_const_iterator (
    ...
    git)  try
{
    *pgit = to_nonconst(new Grid_Generator_System::const_iterator(*to_const(
                                                                      git)));
    return 0;
}
CATCH_ALL
...
int
ppl_Grid_Generator_System_begin (ppl_const_Grid_Generator_System_t          gs,
...
int
ppl_Grid_Generator_System_end (ppl_const_Grid_Generator_System_t          gs,
                               ppl_Grid_Generator_System_const_iterator_t git)
try
{
    const Grid_Generator_System & ggs            = *to_const(gs);
                                       ...
                                       ppl_dimension_type    * m) try
{
    ...
    *m = static_cast<ppl_dimension_type>(mmip.constraints_end() -
                                         mmip.constraints_begin());
    return 0;
}
CATCH_ALL
...
int
ppl_PIP_Problem_number_of_parameter_space_dimensions (ppl_const_PIP_Problem_t
                                                      pip,
                                                      ppl_dimension_type * m)
try
{
                                       ...
                                       ppl_dimension_type    * m) try
{
    ...
    *m = static_cast<ppl_dimension_type>(ppip.constraints_end() -
                                         ppip.constraints_begin());
    return 0;
}
CATCH_ALL
...
int
ppl_PIP_Tree_Node_begin (ppl_const_PIP_Tree_Node_t
                         pip_tree,
...
int
ppl_PIP_Tree_Node_end (ppl_const_PIP_Tree_Node_t
                       pip_tree,
                       ppl_Artificial_Parameter_Sequence_const_iterator_t pit)
try
{
...
int
ppl_PIP_Solution_Node_get_parametric_values (ppl_const_PIP_Solution_Node_t
                                             pip_sol,
                                             ppl_dimension_type              var,
                                             ppl_const_Linear_Expression_t * le)
try
{
    ...
    const Linear_Expression & lle      = spip_sol.parametric_values(Variable(
                                                                        var));
...
int
ppl_Artificial_Parameter_get_Linear_Expression (ppl_const_Artificial_Parameter_t
                                                ap,
...
int
ppl_Artificial_Parameter_inhomogeneous_term (ppl_const_Artificial_Parameter_t
                                             ap, ppl_Coefficient_t n) try
{
    const Artificial_Parameter & sap = *to_const(ap);
    Coefficient & nn                 = *to_nonconst(n);
    ...
    src) try
{
    ...
    Artificial_Parameter_Sequence::const_iterator & ddst       = *to_nonconst(
        dst);
...
ppl_Artificial_Parameter_Sequence_const_iterator_dereference (
    ...
    * pap) try
{
    const Artificial_Parameter_Sequence::const_iterator & papit = *to_const(
        apit);
...
ppl_io_get_variable_output_function (
    ppl_io_variable_output_function_type * * pp)
try
{
