...
ppl_termination_test_C_Polyhedron_MS(_) :- fail.
ppl_termination_test_C_Polyhedron_PR(_) :- fail.
ppl_termination_test_NNC_Polyhedron_MS(_) :- fail.
ppl_termination_test_NNC_Polyhedron_PR(_) :- fail.
%:- use_module(ppl_ciao, [
%        ppl_version_major/1,
%        ppl_version_minor/1,
