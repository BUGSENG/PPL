...
{
public:
not_a_pip_problem_control_parameter_name (Prolog_term_ref term, const
                                          char * where)
    : internal_exception(term, where)
{
}
...
{
public:
not_a_pip_problem_control_parameter_value (Prolog_term_ref term, const
                                           char * where)
    : internal_exception(term, where)
{
}
...
Prolog_atom
term_to_pip_problem_control_parameter_value(Prolog_term_ref t, const
                                            char * where);
