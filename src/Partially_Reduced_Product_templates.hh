...
bool shrink_to_congruence_no_check (D1 & d1, D2 & d2, const Congruence & cg)
{
    ...
    if (d2.maximize(e, max_numer, max_denom, max_included))
    {
        ...
        {
            // Adjust values to allow for the denominators max_denom and
            // min_denom.
            max_numer *= min_denom;
            min_numer *= max_denom;
            ...
            // If the difference between the maximum and minimum bounds is more
            // than
            ...
            if ((max_numer - min_numer < mod2)
                || ((max_numer - min_numer == mod2) && (!max_included ||
                                                        !min_included)))
            {
                ...
                else
                {
                    if (max_decreased < min_increased)
                    {
                        ...
                        // In this case, d intersects no hyperplanes defined by
                        // cg,
