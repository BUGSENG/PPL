...
/*! \ingroup PPL_CXX_interface
 ...
 \,\bigr\}.
   ...
   affine space is the given affine space translated 3 integers to the right
      (all the
   ...
   Linear_Expression expr = x + y;
   \endcode
   the resulting affine space is a similar affine space to the result in Example
      6,
...
//! \name Space Dimension Preserving Member Functions that May Modify the
// Affine_Space
//@{
...
#include "Affine_Space_inlines.hh"
