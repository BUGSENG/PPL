    ...
    const Floating_Point_Format analyzed_format)
{
    ...
    static PPL_TLS FP_Interval_Type ieee754_half_result =
        ZERO_INTERVAL;
    static PPL_TLS FP_Interval_Type ieee754_single_result =
        ZERO_INTERVAL;
    static PPL_TLS FP_Interval_Type ieee754_double_result =
        ZERO_INTERVAL;
    static PPL_TLS FP_Interval_Type ibm_single_result =
        ZERO_INTERVAL;
    static PPL_TLS FP_Interval_Type ieee754_quad_result =
        ZERO_INTERVAL;
    static PPL_TLS FP_Interval_Type intel_double_extended_result =
        ZERO_INTERVAL;
