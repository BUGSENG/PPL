...
PPL_TLS const PPL::Constraint* PPL::Constraint::zero_dim_false_p = nullptr;
PPL_TLS const PPL::Constraint* PPL::Constraint::zero_dim_positivity_p = nullptr;
PPL_TLS const PPL::Constraint* PPL::Constraint::epsilon_geq_zero_p = nullptr;
PPL_TLS const PPL::Constraint* PPL::Constraint::epsilon_leq_one_p = nullptr;
