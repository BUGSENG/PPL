...
struct float_ieee754_half
{
    ...
    static const int          EXPONENT_MAX  = (1 << (EXPONENT_BITS - 1)) -
                                              1;
...
struct float_ieee754_quad
{
    ...
    static const uint64_t MSP_POS_INF =
        static_cast<uint64_t>(0x7fff000000000000ULL);
    static const uint64_t MSP_NEG_INF =
        static_cast<uint64_t>(0xffff000000000000ULL);
    ...
    static const uint64_t MSP_MAX  =
        static_cast<uint64_t>(0x7ffeffffffffffffULL);
