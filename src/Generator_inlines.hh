...
rectilinear_distance_assign (Checked_Number<To, Extended_Number_Policy> & r,
                             ...
                             Temp                                       & tmp2)
{
    return l_m_distance_assign<Rectilinear_Distance_Specialization<Temp> >(r, x,
                                                                           y,
                                                                           dir,
                                                                           tmp0,
                                                                           tmp1,
...
euclidean_distance_assign (Checked_Number<To, Extended_Number_Policy> & r,
                           ...
                           Temp                                       & tmp2)
{
    return l_m_distance_assign<Euclidean_Distance_Specialization<Temp> >(r, x,
                                                                         y, dir,
                                                                         tmp0,
                                                                         tmp1,
                                                                         tmp2);
...
l_infinity_distance_assign (Checked_Number<To, Extended_Number_Policy> & r,
                            ...
                            Temp                                       & tmp2)
{
    return l_m_distance_assign<L_Infinity_Distance_Specialization<Temp> >(r, x,
                                                                          y,
                                                                          dir,
                                                                          tmp0,
                                                                          tmp1,
