    ...
    else
    {
        ...
        else if (is_pinf<From2_Policy>(y))
        {
            switch (sgn<From1_Policy>(x))
            {
                case VR_LT:
minf:
                    return assign_special<To_Policy>(to, VC_MINUS_INFINITY,
                                                     dir);
...
a_minf:
                    ...
                    if (CHECK_P(To_Policy::check_inf_add_inf,
                                is_pinf<To_Policy>(to)))
                    {
                        goto inf_add_inf;
                    }
                    else
...
native:
            return add_mul<To_Policy, From1_Policy, From2_Policy>(to, x, y,
                                                                  dir);
        }
    }
}
...
a_minf:
                    ...
                    if (CHECK_P(To_Policy::check_inf_sub_inf,
                                is_minf<To_Policy>(to)))
                    {
                        goto inf_sub_inf;
                    }
...
native:
            return sub_mul<To_Policy, From1_Policy, From2_Policy>(to, x, y,
                                                                  dir);
        }
    }
}
            ...
            Rounding_Dir dir)
{
    ...
    {
        return gcdext<To1_Policy, To2_Policy, To3_Policy, From1_Policy,
                      From2_Policy>(to, s, t, x, y, dir);
    }
}
