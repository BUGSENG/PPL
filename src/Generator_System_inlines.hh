...
inline
Generator_System::Generator_System (const Topology topol, const Representation
                                    r)
    : sys(topol, r)
{
}
...
inline
Generator_System_const_iterator::Generator_System_const_iterator (const
...
Generator_System_const_iterator::operator= (const
                                            Generator_System_const_iterator & y)
{
    i   = y.i;
    gsp = y.gsp;
    return *this;
...
inline
Generator_System_const_iterator::
Generator_System_const_iterator (const
                                 Linear_System<Generator>::const_iterator & iter,
