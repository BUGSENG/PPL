         ...
         old_gensys_end = old_gensys.end(); i != old_gensys_end; ++i)
    {
        ...
        switch (old_g.type())
        {
            ...
            case Generator::CLOSURE_POINT:
                // A closure point in the origin has all zero homogeneous
                // coefficients.
...
template <typename FP_Format, typename Interval_Info>
void
Polyhedron::affine_form_image (const Variable
                               var,
                               const Linear_Form<Interval <FP_Format,
                                                           Interval_Info> > & lf)
{
...
void
Polyhedron
::overapproximate_linear_form (const Linear_Form<Interval <FP_Format,
                                                           Interval_Info> > & lf,
                               const dimension_type
                               lf_dimension,
                               Linear_Form<Interval <FP_Format,
                                                     Interval_Info> > & result)
{
