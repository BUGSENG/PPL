                                                   ...
                                                   Coefficient & c_coeff)
{
    ...
    {
        // c_first_var is the only inhomogeneous coefficient different from
        // zero.
    ...
    // form:
    // a*x - a*y <=/= b.
    Coefficient_traits::const_reference c0 = c.expression().get(Variable(
                                                                    c_first_var
                                                                    - 1));
    Coefficient_traits::const_reference c1 = c.expression().get(Variable(
                                                                    c_second_var
                                                                    - 1));
