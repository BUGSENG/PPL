...
test03 ()
{
    ...
    bool ok = pip1.space_dimension() == pip2.space_dimension()
              && 2 == std::distance(pip1.constraints_begin(),
                                    pip1.constraints_end())
              && 2 == std::distance(pip2.constraints_begin(),
                                    pip2.constraints_end());
...
test04 ()
{
    ...
    bool ok = pip1.space_dimension() == pip2.space_dimension()
              && 1 == std::distance(pip1.constraints_begin(),
                                    pip1.constraints_end())
              && 1 == std::distance(pip2.constraints_begin(),
                                    pip2.constraints_end());
