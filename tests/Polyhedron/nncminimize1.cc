...
test01 ()
{
    ...
    bool                     ok1    = (std::distance(min_gs.begin(),
                                                     min_gs.end()) == 8);
...
test05 ()
{
    ...
    const int                 num_constraints = std::distance(ph1_cs.begin(),
                                                              ph1_cs.end());

    const Constraint_System & ph1_min_cs =
        ph1.minimized_constraints();
    const int num_minimized_constraints = std::distance(
        ph1_min_cs.begin(),
        ph1_min_cs
        .end());
...
test07 ()
{
    ...
    const Generator_System & min_gs = ph.minimized_generators();
    bool                     ok     = (2 == std::distance(min_gs.begin(),
                                                          min_gs.end()));
