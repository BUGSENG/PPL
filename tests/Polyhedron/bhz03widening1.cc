...
test01 ()
{
    ...
    for (unsigned n = 1; !converged && n <= 20; ++n)
    {
        ...
        Sn.BHZ03_widening_assign<BHRZ03_Certificate>(T, widen_fun_ref(
                                                         &Polyhedron::
                                                         H79_widening_assign));
...
test02 ()
{
    ...
    P.BHZ03_widening_assign<BHRZ03_Certificate>(Q, widen_fun_ref(
                                                    &Polyhedron::
                                                    H79_widening_assign));
...
test03 ()
{
    ...
    T2.BHZ03_widening_assign<BHRZ03_Certificate>(T1, widen_fun_ref(
                                                     &Polyhedron::
                                                     H79_widening_assign));
...
test04 ()
{
    ...
    for (unsigned n = 1; !converged && n <= 20; ++n)
    {
        ...
        Sn.upper_bound_assign(T);
        Sn.BHZ03_widening_assign<H79_Certificate>(T, widen_fun_ref(
                                                      &Polyhedron::
                                                      H79_widening_assign));
...
test05 ()
{
    ...
    P.BHZ03_widening_assign<H79_Certificate>(Q, widen_fun_ref(
                                                 &Polyhedron::
                                                 H79_widening_assign));
