...
test02 ()
{
    ...
    Coefficient valn2;
    Coefficient vald2;
    bool        ok = (gr1.frequency(Linear_Expression(0), num1, den1, valn1,
                                    vald1)
                      && num1 == 0 && den1 == 1 && valn1 == 0 && vald1 == 1
                      && !gr2.frequency(Linear_Expression(0), num2, den2, valn2,
                                        vald2));
...
test04 ()
{
    ...
    Coefficient valn;
    Coefficient vald;
    bool        ok = (!gr.frequency(Linear_Expression(B), num, den, valn,
                                    vald));
...
test05 ()
{
    ...
    Coefficient valn;
    Coefficient vald;
    bool        ok = (gr.frequency(Linear_Expression(A + B - 3), num, den, valn,
                                   vald)
                      && num == 1 && den == 1 && valn == 0 && vald == 1);
...
test06 ()
{
    ...
    Coefficient valn;
    Coefficient vald;
    bool        ok = (gr.frequency(Linear_Expression(2 * A + B), num, den, valn,
                                   vald)
...
test07 ()
{
    ...
    Coefficient valn;
    Coefficient vald;
    bool        ok = (gr.frequency(Linear_Expression(2 * A + 3 * B), num, den,
                                   valn, vald)
                      && num == 2 && den == 1 && valn == 1 && vald == 1);
