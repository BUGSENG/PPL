...
test01 ()
{
    ...
    bool ok = (!gr.maximize(Linear_Expression(0), extr_n, extr_d, dummy, pnt)
               && !gr.minimize(Linear_Expression(0), extr_n, extr_d, dummy,
                               pnt));
...
test04 ()
{
    ...
    ok &= check_maximize(
        gr_gs_needs_min, le, 5, 3, exp_pnt, "gr_gs_needs_min")
          && check_minimize(gr_gs_needs_min, le, 5, 3, exp_pnt,
                            "gr_gs_needs_min");

    ok &= check_maximize(
        gr_cgs_needs_min, le, 5, 3, exp_pnt, "gr_cgs_needs_min")
          && check_minimize(gr_cgs_needs_min, le, 5, 3, exp_pnt,
                            "gr_cgs_needs_min");
...
test07 ()
{
    ...
    ok &= check_maximize(gr_gs_needs_min, le, 0, 1, exp_pnt, "gr_gs_needs_min")
          && check_minimize(gr_gs_needs_min, le, 0, 1, exp_pnt,
                            "gr_gs_needs_min");
...
test11 ()
{
    ...
    ok &= check_maximize(gr_gs_needs_min, le, 2, 1, exp_pnt1, "gr_gs_needs_min")
          && check_minimize(gr_gs_needs_min, le, 2, 1, exp_pnt1,
                            "gr_gs_needs_min");
...
test12 ()
{
    ...
    ok &= check_maximize(gr_gs_needs_min, le, 99, 1, exp_pnt, "gr_gs_needs_min")
          && check_minimize(gr_gs_needs_min, le, 99, 1, exp_pnt,
                            "gr_gs_needs_min");
