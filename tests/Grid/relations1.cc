...
test02 ()
{
    ...
    bool ok = (gr.relation_with(grid_point(A)) ==
...
test03 ()
{
    ...
    bool ok
        = (gr.relation_with(grid_point(A + B)) ==
           Poly_Gen_Relation::subsumes());
...
test20 ()
{
    ...
    bool ok
        = (gr.relation_with(closure_point(A + B)) ==
           Poly_Gen_Relation::subsumes()
           && gr.relation_with(closure_point(A)) ==
           Poly_Gen_Relation::subsumes());
