...
test09 ()
{
    ...
    bds.generalized_affine_preimage(B, LESS_OR_EQUAL, -3 * A - 2 * B + 7 * C +
                                    1, 2);
...
test13 ()
{
    ...
    bds.generalized_affine_preimage(B, GREATER_OR_EQUAL, -3 * A - 2 * B + 7 *
                                    C + 1, -2);
...
test14 ()
{
    ...
    bds.generalized_affine_preimage(B, GREATER_OR_EQUAL, 3 * A - 2 * B - 7 * C +
                                    1, -3);
