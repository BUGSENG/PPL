...
test02 ()
{
    ...
    bool              ok = (bds1.frequency(three, num1, den1, valn1, vald1)
                            && num1 == 0 && den1 == 1 && valn1 == 3 && vald1 ==
                            1
                            && !bds2.frequency(three, num2, den2, valn2,
                                               vald2));
...
test04 ()
{
    ...
    Coefficient valn;
    Coefficient vald;
    bool        ok = (!bds.frequency(Linear_Expression(A), num, den, valn,
                                     vald));
...
test05 ()
{
    ...
    Coefficient valn;
    Coefficient vald;
    bool        ok = (!bds.frequency(Linear_Expression(B), num, den, valn,
                                     vald));
...
test06 ()
{
    ...
    Coefficient valn;
    Coefficient vald;
    bool        ok = (bds.frequency(Linear_Expression(A + B - 3), num, den,
                                    valn, vald)
                      && num == 0 && den == 1 && valn == 0 && vald == 1);
...
test07 ()
{
    ...
    Coefficient valn;
    Coefficient vald;
    bool        ok = (!bds.frequency(Linear_Expression(A - B), num, den, valn,
                                     vald));
