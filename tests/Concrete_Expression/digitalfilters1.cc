...
test05 ()
{
    ...
    do
    {
        ...
        // S = Y;
        Approximable_Reference<C_Expr> var_y(FP_Type, Int_Interval(mpz_class(
                                                                       0)),
                                             Y.id());
        ...
        bd_then.refine_with_linear_form_inequality(FP_Linear_Form(R),
                                                   -FP_Linear_Form(D));
        or_then.int_store.intersection_assign(FP_Interval_Abstract_Store(
                                                  bd_then));
        ...
        oracle.int_store.limited_CC76_extrapolation_assign(or_begin.int_store,
                                                           cs);
...
#define COND_float           PPL_CPP_EQ(PPL_CPP_FP_FORMAT(ANALYZER_FP_FORMAT), \
                                        1)
#define COND_double          PPL_CPP_EQ(PPL_CPP_FP_FORMAT(ANALYZER_FP_FORMAT), \
                                        2)
