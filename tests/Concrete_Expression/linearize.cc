...
test02 ()
{
    ...
    Approximable_Reference<C_Expr>  var0(FP_Type, Int_Interval(mpz_class(0)),
                                         0);
    Approximable_Reference<C_Expr> var1(FP_Type, Int_Interval(mpz_class(0)),
                                        1);
    ...
    FP_Linear_Form known_result(compute_absolute_error<FP_Interval>(
                                    ANALYZED_FP_FORMAT));
...
test08 ()
{
    ...
    Integer_Constant<C_Expr> ic_expr(Concrete_Expression_Type::bounded_integer(
                                         BITS_32, UNSIGNED, OVERFLOW_WRAPS), i);
    ...
    Approximable_Reference<C_Expr> var(
        Concrete_Expression_Type::bounded_integer(BITS_32, UNSIGNED,
                                                  OVERFLOW_WRAPS), i, 0);
