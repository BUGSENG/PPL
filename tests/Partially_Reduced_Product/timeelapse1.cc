...
test01 ()
{
    ...
    print_congruences(prp1,
                      "*** prp1.time_elapse_assign(prp1) congruences ***");
    print_constraints(prp1,
                      "*** prp1.time_elapse_assign(prp1) constraints ***");
    print_congruences(prp2,
                      "*** prp2.time_elapse_assign(prp2) congruences ***");
    print_constraints(prp2,
                      "*** prp2.time_elapse_assign(prp2) constraints ***");
