...
test09 ()
{
    ...
    box.generalized_affine_preimage(B, LESS_OR_EQUAL, -3 * A - 2 * B + 7 * C +
                                    1, 2);
    ph.generalized_affine_preimage(B, LESS_OR_EQUAL, -3 * A - 2 * B + 7 * C + 1,
                                   2);
...
test13 ()
{
    ...
    box.generalized_affine_preimage(B, GREATER_OR_EQUAL, -3 * A - 2 * B + C + 1,
                                    -2);
    ph.generalized_affine_preimage(B, GREATER_OR_EQUAL, -3 * A - 2 * B + C + 1,
                                   -2);
...
test15 ()
{
    ...
    box.generalized_affine_preimage(B, GREATER_OR_EQUAL, 3 * A - 2 * B - 7 * C +
                                    1, -3);
    ph.generalized_affine_preimage(B, GREATER_OR_EQUAL, 3 * A - 2 * B - 7 * C +
                                   1, -3);
