...
test02 ()
{
    ...
    Coefficient valn2;
    Coefficient vald2;
    bool        ok = (box1.frequency(Linear_Expression(3), num1, den1, valn1,
                                     vald1)
                      && num1 == 0 && den1 == 1 && valn1 == 3 && vald1 == 1
                      && !box2.frequency(Linear_Expression(3), num2, den2,
                                         valn2, vald2));
...
test04 ()
{
    ...
    Coefficient valn;
    Coefficient vald;
    bool        ok = (!box.frequency(Linear_Expression(A), num, den, valn,
                                     vald));
...
test05 ()
{
    ...
    Coefficient valn;
    Coefficient vald;
    bool        ok = (!box.frequency(Linear_Expression(B), num, den, valn,
                                     vald));
...
test06 ()
{
    ...
    Coefficient valn;
    Coefficient vald;
    bool        ok = (box.frequency(Linear_Expression(A + B - 3), num, den,
                                    valn, vald)
...
test07 ()
{
    ...
    Coefficient valn;
    Coefficient vald;
    bool        ok = (!box.frequency(Linear_Expression(A - B), num, den, valn,
                                     vald));
