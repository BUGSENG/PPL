...
test01 ()
{
    ...
    // Cost function.
    Linear_Expression cost(-10 * X02 - 8 * X14 - 15 * X23 - 12 * X36 + 250 *
                           X39);
...
test02 ()
{
    ...
    pg_kr = point(22 * B + 1846 * C + 863 * D + 312468 * E + 15090 * F + 950 *
                  G + 0 * H, 76);
    ...
    nout << "Optimizing point = ";
    print_generator(pg);
    pg_kr = point(782 * B + 1598 * C + 138244 * E + 2890 * F + 425 * G + 7767 *
                  H, 34);
...
test08 ()
{
    ...
    pg_kr = point(Coefficient("6651564805") * A + 196469466 * B + 232165453 *
                  C + 0 * D,
