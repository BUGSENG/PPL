...
test02 ()
{
    ...
    try
    {
        // This tries to build an invalid MIP_Problem object: the space
        // dimension
...
test09 ()
{
    ...
    try
    {
        // This tries to make the cost function incompatible with the
        // MIP_Problem
        // space dimension.
...
test15 ()
{
    ...
    try
    {
        // This tries to add Constraint_System that contains a strict
        // inequality.
        mip.add_constraints(incompatible_cs);
    }
    catch (std::invalid_argument & e)
