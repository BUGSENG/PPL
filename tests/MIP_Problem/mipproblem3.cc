...
test10 ()
{
    ...
    if ((pg != point(Coefficient("17591821432561") * x1 + Coefficient(
                         "")
                     * x2, Coefficient(
                         "")))
        || (num != Coefficient(
                ""))
        || (den != Coefficient(
                "")))
    {
        return false;
