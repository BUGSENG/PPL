...
test01 ()
{
    ...
    const memory_size_type oct_external_size =
        oct.external_memory_in_bytes();
...
bool test02 ()
{
    ...
    const memory_size_type poct_external_size =
        poct.external_memory_in_bytes();
    const memory_size_type pqoct_total_size    = pqoct.total_memory_in_bytes();
    const memory_size_type pqoct_external_size =
        pqoct.external_memory_in_bytes();
    const memory_size_type proct_total_size    = proct.total_memory_in_bytes();
    const memory_size_type proct_external_size =
        proct.external_memory_in_bytes();
